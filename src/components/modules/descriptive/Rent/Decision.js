...
export default class Decision extends Component {
    render() {
        return (
            <div>
                <Form.List name="rentContractDecision">
                    {(fields, dn) => {
                        if (fields.length === 0) {
                            dn.add()
                            ...
                            <div>
                                <table class="customtable" id="dataTable" name="dataTable" width="fit-content" border="1">
                                    <tr>
                                        ...
                                        <td align="center" bgcolor="#c6c4c4"><label style={{ fontSize: "14px", fontWeight: "bold" }}>تاريخ الغاء القرار</label></td>
                                        <td align="center" bgcolor="#c6c4c4"><label style={{ fontSize: "14px", fontWeight: "bold" }}>ملاحظات</label></td>
                                    </tr>
                                    {fields.map((field, i) => (
                                        <tr>
                                            <td align="center">
