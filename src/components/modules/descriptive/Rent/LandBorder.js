    ...
    return (
        <table class="customtable" width="700" border="1" align="right">
            ...
            <tr name="row2">
                ...
                <td align="right">
                    <Item
                        rules={[{ required: true, message: 'يجب الادخال' }]}  name={["rentContract", "southNeighbour"]}>
                        <Input.TextArea />
                    </Item>
                </td>
                <td align="right">
            ...
            <tr name="row3">
                ...
                <td align="right">
                    <Item
                        rules={[{ required: true, message: 'يجب الادخال' }]}  name={["rentContract", "eastNeighbour"]}>
                        <Input.TextArea />
                    </Item>
                </td>
                <td align="right">
            ...
            <tr name="row4">
                ...
                <td align="right">
                    <Item
                        rules={[{ required: true, message: 'يجب الادخال' }]}  name={["rentContract", "westNeighbour"]}>
                        <Input.TextArea />
                    </Item>
                </td>
                <td align="right">
